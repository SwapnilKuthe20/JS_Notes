...
// // let longText = "Lorem ipsum dolor sit amet, adipiscing elit. Sed do eiusmod tempor incididunt ut labore.";
...
//              searchString (required): The substring to search for at the end of the main string.
//              length (optional): The length of the string to consider (default is the full length).
...
// // You can use the endsWith() method to check if an email address belongs to a specific domain 
//      (e.g., for a business that only accepts company emails).
