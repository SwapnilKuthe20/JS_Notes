...
//1. Imagine you are building a contact management app, and you want to display the names alphabetically.

// let contacts = ["swap", "girish", "Sneel", "Kiran", "Kittu", "Chintu", "Sandi", "Chetan", "chiku"];
// contacts.sort();
// console.log(contacts, "....Alfabetical");
// ['Chetan', 'Chintu', 'Kiran', 'Kittu', 'Sandi', 'Sneel', 'chiku', 'girish', 'swap']
// -----------------------------------------------------------------------------------------------
